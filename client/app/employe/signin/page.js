...
const page = () => {
  ...
  return (
    ...
    //   <Link href='/employe/forget'>Forget Link</Link>

    // </div>


    <div className="flex flex-col items-center justify-center min-h-[80vh] py-2 bg-gray-100">
    <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
      <div className="bg-white relative rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
